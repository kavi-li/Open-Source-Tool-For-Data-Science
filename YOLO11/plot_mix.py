...
Name: lijiayi
IDE: PyCharm
FileName: plot_mix.py
Date: 2024/11/7 22:42
"""
import os
import pandas as pd
...
def plot_metrics_and_loss(experiment_names, metrics_info, loss_info, metrics_subplot_layout, loss_subplot_layout,
                          metrics_figure_size=(15, 10), loss_figure_size=(15, 10), base_directory='/Users/karidalee/Desktop/ultralytics-main/runs/detect'):
    # Plot metrics
...
metrics_filename, loss_filename = plot_metrics_and_loss(
    experiment_names=['YOLO11s', 'YOLO11s_MSDA', 'YOLOv8'],
